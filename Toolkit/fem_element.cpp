 ...
 * 
 * @param p0 Placeholder text.
 * @param p1 Placeholder text.
 * @param p2 Placeholder text.
 * @param p3 Placeholder text.
 */
...
/**
 * Computes the strain velocity of the 3D tetrahedra element.
 * 
 * @param p0 Placeholder text.
 * @param p1 Placeholder text.
 * @param p2 Placeholder text.
 * @param p3 Placeholder text.
 * @param v0 Placeholder text.
 * @param v1 Placeholder text.
 * @param v2 Placeholder text.
 * @param v3 Placeholder text.
 */
