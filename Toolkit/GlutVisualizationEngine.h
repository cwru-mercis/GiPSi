...
The Original Code is Glut Visualization Engine Definition
...
////	GLUTVISUALIZATIONENGINE.H v0.0
////
////////////////////////////////////////////////////////////////
...
class GlutVisualizationEngine : public VisualizationEngine
{
...
public:
	GlutVisualizationEngine(int argc, char **argv, DisplayBuffer * dbHead,
							XMLNode * visualizationNode,
							int x, int y, int width, int height);
	virtual void Start(SimulationKernel * newSimKernel);
