...
class FEM_3LMObject: public DeformableSolidObject {
public:
	...
	FEM_3LMObject(	XMLNode * simObjectNode,
					Real in_g		= 10.0, 
					Real mass		= 1.0);
	// Loaders
...
class FEMBoundary : public DeformableSolidBoundary {
public:
	// Initializer
...
class FEMDomain : public DeformableSolidDomain {
public:
	// Initializer
