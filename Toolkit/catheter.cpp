...
The Original Code is Catheter HIO Implementation (catheter.cpp).
...
////	CATHETER.CPP v0.0
////
////	Implementation the Catheter Haptic Interface Object 
////
////////////////////////////////////////////////////////////////
...
CatheterHIO::CatheterHIO(XMLNode * simObjectNode) :
...
//////////////////////////////////////
//
//	CatheterHIO::InitializeVisualization()
//
//		Initialize visualization parameters
//
void CatheterHIO::InitializeVisualization(XMLNodeList * simObjectChildren)
{
	try
	{
		// Extract baseColor
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::LoadGeometry()
//
//		Initialize visualization parameters
//
void CatheterHIO::LoadGeometry(XMLNodeList * simObjectChildren)
{
	try
	{
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::InitializeTransformation()
//
//		Initialize transformation parameters
//
void CatheterHIO::InitializeTransformation(XMLNodeList * simObjectChildren)
{
	try
	{
...
//		Reads in .obj file
//
void CatheterHIO::Load(char *filename)   
{
	/****************************************************/
...
*/
	...
	// Allocate domain
	if((domain = new CatheterHIODomain()) == NULL) {
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::LoadBoundary()
//
//		Reads in .obj file for boundary
//
void CatheterHIO::LoadBoundary(char *filename)   
{
	/****************************************************/
	/*	Load Obj file containing instrument geometry	*/
	/****************************************************/
	...
	// initialize
	boundary = (CatheterHIOBoundary*)new CatheterHIOBoundary();
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::LoadBoundaryMap()
//
//		Reads in .map file for mapping from boundary to geometry
//
void CatheterHIO::LoadBoundaryMap(char *filename)
{
	FILE			*fp;
	unsigned int	i;
	char			errmsg[1024], 
...
void CatheterHIO::Init(void)
{
	...
	State2Bound();
	CatheterHIOBoundary *bound = (CatheterHIOBoundary *) boundary;
	bound->Init(this);
	//bound->SetNullModel();
	...
	/*	Set up domain						*/
	/****************************************/
	CatheterHIODomain *dom = (CatheterHIODomain *) domain;
	dom->Init(this);
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::Simulate()
//
//		Simulates the CatheterHIO object by a single timestep
//
//
void CatheterHIO::Simulate(void)
{
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::Geom2State()
//
//		Copies geometry to state
//
//
inline void CatheterHIO::Geom2State(void)
{
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::State2Geom()
//
//		Copies state to geometry
//
//
inline void CatheterHIO::State2Geom(void)
{
	TriSurface *geom = (TriSurface *) geometry;
	Matrix<Real> g_w_c = GetConfiguration();
	...
	GetRotationMatrix(rotation, g_w_c);
	geom->Rotate(rotation);		
	// translate 
	Vector<Real> translate = zero_vector3;
	GetTranslationVector(translate, g_w_c);
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::State2Bound()
//
//		Copies state to boundary
//
//
inline void CatheterHIO::State2Bound(void)
{
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::Geom2Bound()
//		Copies geometry to boundary
//
inline void CatheterHIO::Geom2Bound(void)
{
	/*
	static TriSurface *geom = (TriSurface *) geometry;
	Boundary *bound = (CatheterHIOBoundary *) boundary;
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::Bound2Geom()
//		Copies boundary to geometry
//
inline void CatheterHIO::Bound2Geom(void)
{
	/*
	TriSurface *geom = (TriSurface *) geometry;
	const Boundary *bound = (CatheterHIOBoundary *) boundary;
...
//	CatheterHIO::Display()
//
//		Displays the CatheterHIO mesh
//
//
void CatheterHIO::Display(void)
{
...
////////////////////////////////////////////////////////////////
//
//	CatheterHIO::SetupDisplay()
//
//		Sets up the display of the the CatheterHIO
//
//
void CatheterHIO::SetupDisplay(XMLNodeList * simObjectChildren) 
{
