 ...
 *	Usage:
 *
 *	1) Create a static mesh interface using callbacks or OPC_Pointers. (see OPC_MeshInterface.cpp).
 *	Keep it around in your app, since a OPC_Pointer to this interface is saved internally and
