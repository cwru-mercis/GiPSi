...
#define __OPC_AABBCOLLIDER_H__
	...
	class OPCODE_API AABBCollider : public VolumeCollider
	{
		...
		protected:
							...
							OPC_Point		mMin;			//!< Query box min OPC_Point
							OPC_Point		mMax;			//!< Query box max OPC_Point
		// Leaf description
		...
		// Internal methods
			...
			// Overlap tests
		inline_				BOOL			AABBContainsBox(const OPC_Point& bc, const OPC_Point& be);
		inline_				BOOL			AABBAABBOverlap(const OPC_Point& b, const OPC_Point& Pb);
