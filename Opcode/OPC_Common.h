...
// [GOTTFRIED]: Just a small change for readability.
	...
	class OPCODE_API CollisionAABB
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	void		SetMinMax(const OPC_Point& min, const OPC_Point& max)		{ mCenter = (max + min)*0.5f; mExtents = (max - min)*0.5f;		}
		...
		inline_	BOOL		IsInside(const CollisionAABB& box) const
				...
				OPC_Point		mCenter;				//!< Box center
				OPC_Point		mExtents;				//!< Box extents
	};
	...
	inline_ void TransformPoint(OPC_Point& dest, const OPC_Point& source, const Matrix3x3& rot, const OPC_Point& trans)
	{
