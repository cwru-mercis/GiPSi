 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL RayCollider::RayTriOverlap(const OPC_Point& vert0, const OPC_Point& vert1, const OPC_Point& vert2)
{
	// Stats
	mNbRayPrimTests++;

	// Find vectors for two edges sharing vert0
	OPC_Point edge1 = vert1 - vert0;
	OPC_Point edge2 = vert2 - vert0;

	// Begin calculating determinant - also used to calculate U parameter
	OPC_Point pvec = mDir^edge2;
...
//		if(IR(u)&0x80000000 || u>det)					return FALSE;
		...
		// Intersection OPC_Point is valid if distance is positive (else it can just be a face behind the orig OPC_Point)
