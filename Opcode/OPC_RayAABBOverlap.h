...
//
// The OPC_Point of intersection is not computed anymore. The distance to impact is not needed anymore
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL RayCollider::SegmentAABBOverlap(const OPC_Point& center, const OPC_Point& extents)
{
	// Stats
	mNbRayBVTests++;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL RayCollider::RayAABBOverlap(const OPC_Point& center, const OPC_Point& extents)
{
	// Stats
	mNbRayBVTests++;
