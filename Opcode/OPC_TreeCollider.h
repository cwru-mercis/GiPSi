...
#define __OPC_TREECOLLIDER_H__
	...
	//! Two model OPC_Pointers and two colliding primitives are cached. Model OPC_Pointers are assigned
					...
					void	ResetCache()
							{
								...
								SepVector.pid	= 0;
								SepVector.qid	= 0;
								SepVector.SV	= OPC_Point(1.0f, 0.0f, 0.0f);
	...
	class OPCODE_API AABBTreeCollider : public Collider
	{
		...
		// Precomputed data
							...
							OPC_Point			mT0to1;				//!< Translation from object0 to object1
							OPC_Point			mT1to0;				//!< Translation from object1 to object0
		// Dequantization coeffs
							OPC_Point			mCenterCoeff0;
							OPC_Point			mExtentsCoeff0;
							OPC_Point			mCenterCoeff1;
							OPC_Point			mExtentsCoeff1;
		// Leaf description
							OPC_Point			mLeafVerts[3];		//!< Triangle vertices
		...
		// Internal methods
			...
			// Quantized AABB trees
							void			_Collide(const AABBQuantizedNode* b0, const AABBQuantizedNode* b1, const OPC_Point& a, const OPC_Point& Pa, const OPC_Point& b, const OPC_Point& Pb);
			// No-leaf AABB trees
			...
			inline_			BOOL			BoxBoxOverlap(const OPC_Point& ea, const OPC_Point& ca, const OPC_Point& eb, const OPC_Point& cb);
			inline_			BOOL			TriBoxOverlap(const OPC_Point& center, const OPC_Point& extents);
			inline_			BOOL			TriTriOverlap(const OPC_Point& V0, const OPC_Point& V1, const OPC_Point& V2, const OPC_Point& U0, const OPC_Point& U1, const OPC_Point& U2);
			// Init methods
