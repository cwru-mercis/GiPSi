...
//! TO BE DOCUMENTED
inline_ BOOL planeBoxOverlap(const OPC_Point& normal, const float d, const OPC_Point& maxbox)
{
	OPC_Point vmin, vmax;
...
#define IMPLEMENT_CLASS3_TESTS						\
	...
	AXISTEST_Z0(e1.y, e1.x, fey1, fex1);			\
													\
	const OPC_Point e2 = mLeafVerts[0] - mLeafVerts[2];	\
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
inline_ BOOL AABBTreeCollider::TriBoxOverlap(const OPC_Point& center, const OPC_Point& extents)
{
	// Stats
	mNbBVPrimTests++;
	...
	const OPC_Point e0 = v1 - v0;
	const OPC_Point e1 = v2 - v1;
	const OPC_Point normal = e0 ^ e1;
...
inline_ BOOL OBBCollider::TriBoxOverlap()
{
	...
	// Hook
	const OPC_Point& extents = mBoxExtents;
	const OPC_Point& v0 = mLeafVerts[0];
	const OPC_Point& v1 = mLeafVerts[1];
	const OPC_Point& v2 = mLeafVerts[2];
...
inline_ BOOL AABBCollider::TriBoxOverlap()
{
	...
	// Hook
	const OPC_Point& center		= mBox.mCenter;
	const OPC_Point& extents	= mBox.mExtents;
