...
#define __OPC_MESHINTERFACE_H__
	...
	{
		const OPC_Point*	Vertex[3];

		bool BackfaceCulling(const OPC_Point& source)
		{
			const OPC_Point& p0 = *Vertex[0];
			const OPC_Point& p1 = *Vertex[1];
			const OPC_Point& p2 = *Vertex[2];
	...
	class OPCODE_API MeshInterface
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						bool				SetPointers(const IndexedTriangle* tris, const OPC_Point* verts);
		inline_	const	IndexedTriangle*	GetTris()			const	{ return mTris;			}
		inline_	const	OPC_Point*			GetVerts()			const	{ return mVerts;		}
		 ...
		 *	\param		vp		[out] required triangle's vertex OPC_Pointers
		...
		inline_			void				GetTriangle(VertexPointers& vp, udword index)	const
											{
												...
												vp.Vertex[0] = (const OPC_Point*)(((ubyte*)mVerts) + T->mVRef[0] * mVertexStride);
												vp.Vertex[1] = (const OPC_Point*)(((ubyte*)mVerts) + T->mVRef[1] * mVertexStride);
												vp.Vertex[2] = (const OPC_Point*)(((ubyte*)mVerts) + T->mVRef[2] * mVertexStride);
	#else
		...
		// User OPC_Pointers
				...
				const	OPC_Point*			mVerts;				//!< Array of vertices
	#ifdef OPC_USE_STRIDE
