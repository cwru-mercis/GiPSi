...
inline_ float OPC_PointAABBSqrDist(const OPC_Point& point, const OPC_Point& center, const OPC_Point& extents)
{
	// Compute coordinates of OPC_Point in box coordinate system
	OPC_Point Closest = point - center;
...
static void Face(int i0, int i1, int i2, OPC_Point& rkPnt, const OPC_Point& rkDir, const OPC_Point& extents, const OPC_Point& rkPmE, float* pfLParam, float& rfSqrDistance)
{
    OPC_Point kPpE;
...
static void CaseNoZeros(OPC_Point& rkPnt, const OPC_Point& rkDir, const OPC_Point& extents, float* pfLParam, float& rfSqrDistance)
{
    OPC_Point kPmE(rkPnt.x - extents.x, rkPnt.y - extents.y, rkPnt.z - extents.z);
...
static void Case0(int i0, int i1, int i2, OPC_Point& rkPnt, const OPC_Point& rkDir, const OPC_Point& extents, float* pfLParam, float& rfSqrDistance)
{
...
static void Case00(int i0, int i1, int i2, OPC_Point& rkPnt, const OPC_Point& rkDir, const OPC_Point& extents, float* pfLParam, float& rfSqrDistance)
{
    float fDelta;
...
static void Case000(OPC_Point& rkPnt, const OPC_Point& extents, float& rfSqrDistance)
{
    float fDelta;
...
static float SqrDistance(const Ray& rkLine, const OPC_Point& center, const OPC_Point& extents, float* pfLParam)
{
    // compute coordinates of line in box coordinate system
    OPC_Point kDiff = rkLine.mOrig - center;
    OPC_Point kPnt = kDiff;
    OPC_Point kDir = rkLine.mDir;
...
inline_ float OPC_SegmentOBBSqrDist(const Segment& segment, const OPC_Point& c0, const OPC_Point& e0)
{
	float fLP;
...
inline_ BOOL LSSCollider::LSSAABBOverlap(const OPC_Point& center, const OPC_Point& extents)
{
	// Stats
	mNbVolumeBVTests++;
