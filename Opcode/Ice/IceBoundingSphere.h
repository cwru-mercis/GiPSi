...
#define __ICEBOUNDINGSPHERE_H__
	...
	class ICEMATHS_API Sphere
	{
		...
		inline_					Sphere()																		{}
		//! Constructor
		inline_					Sphere(const OPC_Point& center, float radius) : mCenter(center), mRadius(radius)	{}
		//! Constructor
								Sphere(udword nb_verts, const OPC_Point* verts);
		//! Copy constructor
		inline_					Sphere(const Sphere& sphere) : mCenter(sphere.mCenter), mRadius(sphere.mRadius)	{}
		//! Destructor
		inline_					~Sphere()																		{}

				BSphereMethod	Compute(udword nb_verts, const OPC_Point* verts);
				bool			FastCompute(udword nb_verts, const OPC_Point* verts);

		// Access methods
		inline_	const OPC_Point&	GetCenter()						const		{ return mCenter; }
		inline_	float			GetRadius()						const		{ return mRadius; }

		inline_	const OPC_Point&	Center()						const		{ return mCenter; }
		inline_	float			Radius()						const		{ return mRadius; }

		inline_	Sphere&			Set(const OPC_Point& center, float radius)		{ mCenter = center; mRadius = radius; return *this; }
		inline_	Sphere&			SetCenter(const OPC_Point& center)				{ mCenter = center; return *this; }
		inline_	Sphere&			SetRadius(float radius)						{ mRadius = radius; return *this; }

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Tests if a OPC_Point is contained within the sphere.
		 *	\param		p	[in] the OPC_Point to test
		 *	\return		true if inside the sphere
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	bool			Contains(const OPC_Point& p)		const
								{
...
#ifdef USE_MIN_MAX
									const OPC_Point& Max = ((ShadowAABB&)&aabb).mMax;
									const OPC_Point& Min = ((ShadowAABB&)&aabb).mMin;
#else
									OPC_Point Max; aabb.GetMax(Max);
									OPC_Point Min; aabb.GetMin(Min);
#endif
									OPC_Point p;
		...
		public:
				OPC_Point			mCenter;		//!< Sphere center
