...
static sdword VPlaneSideEps(const OPC_Point& v, const Plane& plane, float epsilon)
{
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OPC_Triangle::Flip()
{
	OPC_Point Tmp = mVerts[1];
	mVerts[1] = mVerts[2];
	mVerts[2] = Tmp;
}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float OPC_Triangle::Area() const
{
	const OPC_Point& p0 = mVerts[0];
	const OPC_Point& p1 = mVerts[1];
	const OPC_Point& p2 = mVerts[2];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float OPC_Triangle::Perimeter()	const
{
	const OPC_Point& p0 = mVerts[0];
	const OPC_Point& p1 = mVerts[1];
	const OPC_Point& p2 = mVerts[2];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float OPC_Triangle::Compacity() const
{
	float P = Perimeter();
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OPC_Triangle::Normal(OPC_Point& normal) const
{
	const OPC_Point& p0 = mVerts[0];
	const OPC_Point& p1 = mVerts[1];
	const OPC_Point& p2 = mVerts[2];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OPC_Triangle::DenormalizedNormal(OPC_Point& normal) const
{
	const OPC_Point& p0 = mVerts[0];
	const OPC_Point& p1 = mVerts[1];
	const OPC_Point& p2 = mVerts[2];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OPC_Triangle::Center(OPC_Point& center) const
{
	const OPC_Point& p0 = mVerts[0];
	const OPC_Point& p1 = mVerts[1];
	const OPC_Point& p2 = mVerts[2];
...
PartVal OPC_Triangle::TestAgainstPlane(const Plane& plane, float epsilon) const
{
...
void Triangle::ComputeMoment(Moment& m)
{
	...
	OPC_Point& p = mVerts[0];
	OPC_Point& q = mVerts[1];
	OPC_Point& r = mVerts[2];
	if(m.mArea==0.0f)
	{
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float OPC_Triangle::MinEdgeLength()	const
{
	float Min = MAX_FLOAT;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float OPC_Triangle::MaxEdgeLength()	const
{
	float Max = MIN_FLOAT;
	float Length01 = mVerts[0].Distance(mVerts[1]);
	float Length02 = mVerts[0].Distance(mVerts[2]);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OPC_Triangle::ComputePoint(float u, float v, OPC_Point& pt, udword* nearvtx)	const
{
	...
	if(nearvtx)
	{
		...
		OPC_Point d(mVerts[0].SquareDistance(pt),	// Distance^2 from vertex 0 to OPC_Point on the face
				mVerts[1].SquareDistance(pt),	// Distance^2 from vertex 1 to OPC_Point on the face
				mVerts[2].SquareDistance(pt));	// Distance^2 from vertex 2 to OPC_Point on the face
...
void OPC_Triangle::Inflate(float fat_coeff, bool constant_border)
{
	// Compute triangle center
	OPC_Point TriangleCenter;
	...
	for(udword i=0;i<3;i++)
	{
		OPC_Point v = mVerts[i] - TriangleCenter;
