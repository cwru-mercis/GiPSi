...
#define __ICEOBB_H__
	...
	class ICEMATHS_API OBB
	{
		...
		inline_						OBB()		{}
		//! Constructor
		inline_						OBB(const OPC_Point& center, const OPC_Point& extents, const Matrix3x3& rot) : mCenter(center), mExtents(extents), mRot(rot)	{}
		//! Destructor
		inline_						~OBB()		{}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				bool				ContainsPoint(const OPC_Point& p)	const;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				bool				ComputeVertexNormals(OPC_Point* pts)	const;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				const OPC_Point*		GetLocalEdgeNormals()	const;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				void				ComputeWorldEdgeNormal(udword edge_index, OPC_Point& world_normal)	const;
		...
		inline_	const OPC_Point&		GetExtents()	const	{ return mExtents;	}
		...
		inline_	void				GetRotatedExtents(Matrix3x3& extents)	const
				...
				OPC_Point				mCenter;		//!< B for Box
				OPC_Point				mExtents;		//!< B for Bounding
