///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Contains code for homogeneous OPC_Points.
 *	\file		IceHPoint.h
...
#define __ICEHPOINT_H__
	...
	class ICEMATHS_API HPoint : public OPC_Point
	{
		public:
		...
		inline_				HPoint(float _x, float _y, float _z, float _w=0.0f) : OPC_Point(_x, _y, _z), w(_w)	{}
		//! Constructor from array
		inline_				HPoint(const float f[4]) : OPC_Point(f), w(f[3])									{}
		//! Constructor from a OPC_Point
		inline_				HPoint(const OPC_Point& p, float _w=0.0f) : OPC_Point(p), w(_w)							{}
		//! Destructor
		inline_				~HPoint()																		{}
		...
		//! Operator for OPC_Point Mul = HPoint * Matrix3x3;
				OPC_Point		operator*(const Matrix3x3& mat)		const;
		...
		//! Cast a HPoint to a OPC_Point. w is discarded.
		inline_				operator	OPC_Point()					const		{ return OPC_Point(x, y, z);									}
