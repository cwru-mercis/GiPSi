...
#define __ICETRILIST_H__
	...
	class ICEMATHS_API TriList : public Container
	{
		...
		inline_	OPC_Triangle*		GetTriangles()		const	{ return (OPC_Triangle*)GetEntries();	}

				void			AddTri(const OPC_Triangle& tri)
								{
				...
				void			AddTri(const OPC_Point& p0, const OPC_Point& p1, const OPC_Point& p2)
								{
