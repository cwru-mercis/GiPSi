...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Tests if a OPC_Point is contained within the OBB.
 *	\param		p	[in] the world OPC_Point to test
 *	\return		true if inside the OBB
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool OBB::ContainsPoint(const OPC_Point& p) const
{
	// OPC_Point in OBB test using lazy evaluation and early exits

	// Translate to box space
	OPC_Point RelPoint = p - mCenter;

	// OPC_Point * mRot maps from box space to world space
	// mRot * OPC_Point maps from world space to box space (what we need here)
...
bool OBB::ComputePlanes(Plane* planes)	const
{
	...
	OPC_Point Axis0 = mRot[0];
	OPC_Point Axis1 = mRot[1];
	OPC_Point Axis2 = mRot[2];
	...
	OPC_Point p0 = mCenter + Axis0 * mExtents.x;
	OPC_Point p1 = mCenter - Axis0 * mExtents.x;
	OPC_Point p2 = mCenter + Axis1 * mExtents.y;
	OPC_Point p3 = mCenter - Axis1 * mExtents.y;
	OPC_Point p4 = mCenter + Axis2 * mExtents.z;
	OPC_Point p5 = mCenter - Axis2 * mExtents.z;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Computes the obb OPC_Points.
 *	\param		pts	[out] 8 box OPC_Points
 *	\return		true if success
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool OBB::ComputePoints(OPC_Point* pts)	const
{
	// Checkings
	if(!pts)	return false;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool OBB::ComputeVertexNormals(OPC_Point* pts)	const
{
	...
	const OPC_Point* VN = (const OPC_Point*)VertexNormals;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
const OPC_Point* OBB::GetLocalEdgeNormals() const
{
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void OBB::ComputeWorldEdgeNormal(udword edge_index, OPC_Point& world_normal) const
{
