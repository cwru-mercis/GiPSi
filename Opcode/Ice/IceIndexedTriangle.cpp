 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::Area(const OPC_Point* verts)	const
{
	if(!verts)	return 0.0f;
	const OPC_Point& p0 = verts[0];
	const OPC_Point& p1 = verts[1];
	const OPC_Point& p2 = verts[2];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::Perimeter(const OPC_Point* verts)	const
{
	if(!verts)	return 0.0f;
	const OPC_Point& p0 = verts[0];
	const OPC_Point& p1 = verts[1];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::Compacity(const OPC_Point* verts) const
{
	if(!verts)	return 0.0f;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::Normal(const OPC_Point* verts, OPC_Point& normal)	const
{
	if(!verts)	return;

	const OPC_Point& p0 = verts[mVRef[0]];
	const OPC_Point& p1 = verts[mVRef[1]];
	const OPC_Point& p2 = verts[mVRef[2]];
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::DenormalizedNormal(const OPC_Point* verts, OPC_Point& normal)	const
{
	if(!verts)	return;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::Center(const OPC_Point* verts, OPC_Point& center)	const
{
	if(!verts)	return;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::CenteredNormal(const OPC_Point* verts, OPC_Point& normal)	const
{
	if(!verts)	return;
	...
	const OPC_Point& p1 = verts[mVRef[1]];
	const OPC_Point& p2 = verts[mVRef[2]];
	OPC_Point Center = (p0+p1+p2)*INV3;
	normal = Center + ((p2-p1)^(p0-p1)).Normalize();
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Computes a random OPC_Point within the triangle.
 *	\param		verts	[in] the list of indexed vertices
 *	\param		normal	[out] the computed centered normal
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::RandomPoint(const OPC_Point* verts, OPC_Point& random)	const
{
	if(!verts)	return;
 ...
 *	\param		verts	[in] the list of indexed vertices
 *	\param		source	[in] source OPC_Point (in local space) from which culling must be computed
 *	\return		true if the triangle is visible from the source OPC_Point
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool IndexedTriangle::IsVisible(const OPC_Point* verts, const OPC_Point& source)	const
{
	// Checkings
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool IndexedTriangle::BackfaceCulling(const OPC_Point* verts, const OPC_Point& source)	const
{
	// Checkings
	if(!verts)	return false;
 ...
 *	\param		verts	[in] the list of indexed vertices
 *	\param		source	[in] source OPC_Point (in local space) from which occlusion potential must be computed
 *	\return		the occlusion potential
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::ComputeOcclusionPotential(const OPC_Point* verts, const OPC_Point& view)	const
{
	if(!verts)	return 0.0f;
	...
	float A = Area(verts);
	OPC_Point N;	Normal(verts, N);
	OPC_Point C;	Center(verts, C);
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::MinEdgeLength(const OPC_Point* verts)	const
{
	if(!verts)	return 0.0f;
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::MaxEdgeLength(const OPC_Point* verts)	const
{
	if(!verts)	return 0.0f;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Computes a OPC_Point on the triangle according to the stabbing information.
 *	\param		verts		[in] the list of indexed vertices
 *	\param		u,v			[in] OPC_Point's barycentric coordinates
 *	\param		pt			[out] OPC_Point on triangle
 *	\param		nearvtx		[out] index of nearest vertex
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void IndexedTriangle::ComputePoint(const OPC_Point* verts, float u, float v, OPC_Point& pt, udword* nearvtx)	const
{
	// Checkings
	if(!verts)	return;
	...
	if(nearvtx)
	{
		...
		OPC_Point d(p0.SquareDistance(pt),	// Distance^2 from vertex 0 to OPC_Point on the face
				p1.SquareDistance(pt),	// Distance^2 from vertex 1 to OPC_Point on the face
				p2.SquareDistance(pt));	// Distance^2 from vertex 2 to OPC_Point on the face
	...
	// |w| = |u||v| |sin(u,v)|
	//**************************************
	float Angle(const OPC_Point& u, const OPC_Point& v)
	{
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float IndexedTriangle::Angle(const IndexedTriangle& tri, const OPC_Point* verts)	const
{
	// Checkings
	if(!verts)	return 0.0f;
