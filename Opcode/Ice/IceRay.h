...
#define __ICERAY_H__
	...
	class ICEMATHS_API Ray
	{
		...
		inline_					Ray()																{}
		//! Constructor
		inline_					Ray(const OPC_Point& orig, const OPC_Point& dir) : mOrig(orig), mDir(dir)	{}
		//! Copy constructor
		...
		inline_			float	Distance(const OPC_Point& point, float* t=null)			const			{ return sqrtf(SquareDistance(point, t));	}
						...
						OPC_Point	mOrig;		//!< Ray origin
						OPC_Point	mDir;		//!< Normalized direction
	};

	inline_ void ComputeReflexionVector(OPC_Point& reflected, const OPC_Point& incoming_dir, const OPC_Point& outward_normal)
	{
		reflected = incoming_dir - outward_normal * 2.0f * (incoming_dir|outward_normal);
	}

	inline_ void ComputeReflexionVector(OPC_Point& reflected, const OPC_Point& source, const OPC_Point& impact, const OPC_Point& normal)
	{
		OPC_Point V = impact - source;
		reflected = V - normal * 2.0f * (V|normal);
	}

	inline_ void DecomposeVector(OPC_Point& normal_compo, OPC_Point& tangent_compo, const OPC_Point& outward_dir, const OPC_Point& outward_normal)
	{
	 ...
	 */
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline_ void ComputeLocalDirection(OPC_Point& local_dir, const OPC_Point& world_dir, const Matrix4x4& world)
	{
...
//		local_dir = InvWorld * world_dir;
	 ...
	 */
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline_ void ComputeLocalPoint(OPC_Point& local_pt, const OPC_Point& world_pt, const Matrix4x4& world)
	{
