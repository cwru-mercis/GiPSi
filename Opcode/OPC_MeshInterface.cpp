 ...
 *	to return 3 vertices to OPCODE (36 bytes) but only 3 OPC_Pointers (12 bytes). It seems better but I never profiled
 *	the alternative.
 *
 ...
 *	- else OPC_Pointers.
 *
 *	If using OPC_Pointers, you can also use strides or not. Strides are used when OPC_USE_STRIDE is defined.
 *
 *
 *	CALLBACKS:
 *
 ...
 *			// Setup OPC_Pointers to vertices for the collision system
 ...
 *	- a vertex made of three 32-bits floating OPC_Point values
 *	- a triangle made of three 32-bits integer vertex references
 *	...then you may want to use OPC_Pointers instead of callbacks. This is the same, except OPCODE will directly
 *	use provided OPC_Pointers to access the topology and geometry, without using a callback. It might be faster,
 *	but probably not as safe. OPC_Pointers have been introduced in OPCODE 1.2.
 *
 *	Ex:
 *
 *	\code
...
udword MeshInterface::CheckTopology()	const
{
	...
	// redundant vertex OPC_Pointers, which cover all possibilities (callbacks/pointers/strides).
...
{
	if(!callback)	return SetIceError("MeshInterface::SetCallback: callback OPC_Pointer is null");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Pointers control: setups object OPC_Pointers. Must provide access to faces and vertices for a given object.
 *	\param		tris	[in] OPC_Pointer to triangles
 *	\param		verts	[in] OPC_Pointer to vertices
 *	\return		true if success
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool MeshInterface::SetPointers(const IndexedTriangle* tris, const OPC_Point* verts)
{
	if(!tris || !verts)	return SetIceError("MeshInterface::SetPointers: OPC_Pointer is null", null);
