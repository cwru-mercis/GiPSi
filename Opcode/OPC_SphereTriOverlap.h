...
BOOL SphereCollider::SphereTriOverlap(const OPC_Point& vert0, const OPC_Point& vert1, const OPC_Point& vert2)
{
	// Stats
	mNbVolumePrimTests++;

	// Early exit if one of the vertices is inside the sphere
	OPC_Point kDiff = vert2 - mCenter;
	...
	OPC_Point TriEdge0	= vert1 - vert0;
	OPC_Point TriEdge1	= vert2 - vert0;
